...
# STARTUP COMMANDS
## show system logo and other info about OS. If admin/root, do not show neofetch. 
## Instead, echo.
if [ "$(whoami)" == 'root' ] || [ "$(whoami)" == 'admin' ] ; then echo "You are now 
        logged in as admin/root."
#else neofetch
fi

## locale. Sets locale so time works.
export LC_ALL=en_US.UTF-8 export LANG=en_US.UTF-8 export LANGUAGE=en_US.UTS-8

## convert apt to nala available here: https://christitus.com/stop-using-apt/
...
## first. All files and folders are listed alphabetically.
alias ls='ls -alh --color --group-directories-first'

## set shutdown and reboot alias to using systemctl
alias shutdown='systemctl poweroff'
alias reboot='systemctl reboot'

## vpn alias
alias vpn-c='protonvpn-cli c -f' # connect fastest 
alias vpn-d='protonvpn-cli d'

## sleek (todo manager) alias
alias sleek='flatpak run com.github.ransome1.sleek'

# launch programs using name. Must have exact name to launch
alias joplin='/home/name/Desktop/Joplin.AppImage' 
alias keepass='/home/name/Desktop/KeePassXC.AppImage' 
alias cryptomator='/home/name/Desktop/Cryptomator.AppImage'
